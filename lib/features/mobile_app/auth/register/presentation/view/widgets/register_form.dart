...
import 'package:alefk/features/mobile_app/auth/register/presentation/view/widgets/text_fields.dart';
import 'package:alefk/features/mobile_app/auth/register/presentation/view/widgets/warning.dart';
          ...
          CustomFilledButton(
            ...
            onPressed: () {
              if (bloc.formKey.currentState?.validate() ?? false) {
                final userName =
                    '${bloc.firstNameController.text} ${bloc.lastNameController.text}';
                final randomId = Random().nextInt(900000000) +
                    100000000; // 9-digit random number
