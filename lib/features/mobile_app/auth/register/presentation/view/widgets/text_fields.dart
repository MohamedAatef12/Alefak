        ...
        return Column(
          ...
          children: [
              ...
              children: [
                Expanded(
                  child: CustomTextFormField(
                    controller:
                        context.read<RegisterBloc>().firstNameController,
                    hintText: 'First Name',
                ...
                Expanded(
                  child: CustomTextFormField(
                      controller:
                          context.read<RegisterBloc>().lastNameController,
                      textInputAction: TextInputAction.next,
                      hintText: 'Last Name',
                      prefixIcon: Icon(IconlyBroken.profile,
                          color: AppColors.current.blue),
            ...
            CustomTextFormField(
                ...
                textInputAction: TextInputAction.next,
                prefixIcon:
                    Icon(IconlyBroken.lock, color: AppColors.current.blue),
            ...
            CustomTextFormField(
                controller:
                    context.read<RegisterBloc>().confirmPasswordController,
                hintText: 'Confirm Password',
                textInputAction: TextInputAction.done,
                prefixIcon:
                    Icon(IconlyBroken.lock, color: AppColors.current.blue),
                obscureText:
                    context.read<RegisterBloc>().obscureConfirmPassword,
                // suffixIcon: IconButton(
                //   color: AppColors.current.blue,
                //   splashColor: AppColors.current.transparent,
                //   highlightColor: AppColors.current.transparent,
