...
import '../../../../auth/delete_account/presentation/view/delete_dialog.dart';
      ...
      child: Column(
        children: [
          GestureDetector(
            ...
            child: ListTile(
              leading:
                  Icon(IconlyBroken.profile, color: AppColors.current.text),
              ...
              child: Column(
                children: [
                  GestureDetector(
                    ...
                    child: ListTile(
                      leading: Icon(IconlyBroken.edit,
                          color: AppColors.current.text),
                    ...
                    child: GestureDetector(
                      onTap: () {
                        DeleteAccountDialog.show(context,
                            onConfirm: (password) {
                          final userId =
                              DI.find<ICacheManager>().getUserData()!.id;
                          context.read<DeleteAccountBloc>().add(
                                DeleteAccountRequestedWithPassword(
                      ...
                      child: ListTile(
                        leading: Icon(IconlyBroken.delete,
          ...
          GestureDetector(
            ...
            child: ListTile(
              leading:
                  Icon(IconlyBroken.setting, color: AppColors.current.text),
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  ListTile(
                    leading:
                        Icon(Icons.language, color: AppColors.current.text),
                    title: Text('Language', style: TextStyles.medium),
                    trailing: Icon(IconlyBroken.arrow_right_2,
                        color: AppColors.current.text),
                  ),
                ],
              ),
          ...
          GestureDetector(
            ...
            child: ListTile(
              leading:
                  Icon(IconlyBroken.info_square, color: AppColors.current.text),
