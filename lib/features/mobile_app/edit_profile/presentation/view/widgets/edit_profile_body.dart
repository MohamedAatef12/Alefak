...
import 'package:alefk/features/mobile_app/edit_profile/presentation/view/widgets/select_age_widget.dart';
import 'package:alefk/features/mobile_app/edit_profile/presentation/view/widgets/select_gender.dart';
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          CustomTextFormField(
            hintText:
                DI.find<ICacheManager>().getUserData()!.address.toString(),
            prefixIcon:
          ...
          CustomTextFormField(
            hintText:
                DI.find<ICacheManager>().getUserData()!.country.toString(),
            prefixIcon:
                Icon(Icons.flag_outlined, color: AppColors.current.blue),
